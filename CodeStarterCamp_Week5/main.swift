...
let badman = TalentedPersonWithBadPersonality(name: "badman", height: 400, singing: .A, dancing: .A, acting: .A, frequancyOfCursing: .C)
var yagomAgency = AuditionManager()

yagomAgency.cast()
yagomAgency.announcePassedApplicants()
